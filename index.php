...
<body>
  ...
  <?php endif; ?>
    ...
    <label><input type="radio" name="color" value="赤">赤</label>
    ...
    性別：
    <input type="checkbox" name="gender[]" value="女" id="gender1">
    <label for="gender1">女</label>

    <input type="checkbox" name="gender[]" value="男" id="gender2">
    <label for="gender2">男</label>

    <input type="checkbox" name="gender[]" value="その他" id="gender3">
